...
void ConfigPanel::Render() {
    ...
    // Informaci�n de memoria (en Windows como ejemplo)
#ifdef _WIN32
    ...
    //// Agregar un combo-box para seleccionar la resoluci�n
    //ImGui::Text("Change Window Resolution:");

    //const char* resolutions[] = {
    //    "1600x900 (ORIGINAL)",  // Resoluci�n original
    //    "1280x720",  // Resoluci�n 720p
    //    "1920x1080", // Resoluci�n 1080p
    //    "2560x1440"  // Resoluci�n 1440p
    //};

    //static int selectedResolution = 0; // �ndice seleccionado en el combo-box

    //// Si la selecci�n cambia, ajustamos el tama�o de la ventana
...
void ConfigPanel::Log(const char* message) {
    // Aqu� podr�as implementar la funcionalidad para loggear mensajes en el panel de configuraci�n
}
